...
{
    QSqlQuery query;
    query.exec("INSERT INTO wiadomosci (nadawca, odbiorca, wiadomosc, data_wiadomości) VALUES ('System', '"+doradca+"', 'Zostales zatrudniony przy przyjeciu organizowanym dnia "+date->toString("dd-MM-yyyy")+"', CURRENT_DATE)");
}
